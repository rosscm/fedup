...
This README will quickly demonstrate how to use `fedup` when testing two sets
of genes. Refer to vignettes for additional information and implementations
(e.g., using single or multiple test sets).
