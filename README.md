...
``` r
fedup_res <- fedup_res[order(fedup_res$fdr, decreasing = TRUE),]
head(fedup_res)
```

    ##                                          pathways size real_total real_pathway
    ## 1:         GO_BP_SC_PROTEIN_TARGETING_TO_MEMBRANE   11         33            1
    ## 2:    GO_BP_SC_LATE_ENDOSOME_TO_VACUOLE_TRANSPORT   14         33            1
    ## 3:                      GO_BP_SC_RESPONSE_TO_HEAT   14         33            1
    ## 4: GO_BP_SC_CELLULAR_PROTEIN_MODIFICATION_PROCESS   17         33            1
    ## 5:           GO_BP_SC_ACTIN_FILAMENT_ORGANIZATION   19         33            1
    ## 6:                    GO_BP_SC_RESPONSE_TO_STRESS   98         33            2
    ##    real_pathway_frac expected_total expected_pathway expected_pathway_frac
    ## 1:          3.030303           5063               11             0.2172625
    ## 2:          3.030303           5063               14             0.2765159
    ## 3:          3.030303           5063               14             0.2765159
    ## 4:          3.030303           5063               17             0.3357693
    ## 5:          3.030303           5063               19             0.3752716
    ## 6:          6.060606           5063               92             1.8171045
    ##    enrichment real_pathway_gene     pvalue fdr
    ## 1:   enriched              ATG4 0.07709450   1
    ## 2:   enriched             ATG18 0.09539419   1
    ## 3:   enriched              WHI2 0.09539419   1
    ## 4:   enriched             ATG10 0.11332057   1
    ## 5:   enriched              WHI2 0.12506797   1
    ## 6:   enriched         WHI2,UTH1 0.13160369   1
